export const THEMES = {
  ...
  nes: {
    ...
    levelPalettes: [
      ['#3cbcfc', '#0058f8', '#fcfcfc'],
      ['#58d854', '#00a800', '#fcfcfc'],
      ['#f878f8', '#d800cc', '#fcfcfc'],
      ['#58d854', '#0058f8', '#fcfcfc'],
      ['#58f898', '#e40058', '#fcfcfc'],
      ['#6888fc', '#58d854', '#fcfcfc'],
      ['#bcbcbc', '#f83800', '#fcfcfc'],
      ['#a80020', '#6844fc', '#fcfcfc'],
      ['#f83800', '#0058f8', '#fcfcfc'],
      ['#fca044', '#f83800', '#fcfcfc'],
    ],
  },
...
export function setChrome(mode = chromeMode) {
  ...
  // PITFALL: installed iOS paints the strip outside the viewport from html's background at first paint, not from theme-color, so both are set here and persisted for the inline boot script.
